...
PIEcrosscorrelation_curves = functionsPIE.correlate_piecesPIE(
...
prompt_indices_ch1 = functions.get_indices_of_time_windows(
    macro_times=macro_times,
...
prompt_indices_ch2 = functions.get_indices_of_time_windows(
    macro_times=macro_times,
...
autocorr_prompt_g = functionsPIE.correlate_pieces_prompt(
    micro_times=micro_times,
    macro_times=macro_times,
...
delay_indices_ch1 = functions.get_indices_of_time_windows(
    macro_times=macro_times,
...
delay_indices_ch2 = functions.get_indices_of_time_windows(
    macro_times=macro_times,
...
autocorr_delay_r = functionsPIE.correlate_pieces_delay(
    micro_times=micro_times,
    macro_times=macro_times,
